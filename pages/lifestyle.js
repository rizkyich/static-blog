...
const Lifestyle = ({initData}) => {
  ...
  return (
    <>
      <Head>
        <title>Artikel seputar lifestyle generasi milenial</title>
        <meta property="og:title" content="Artikel seputar lifestyle generasi milenial"></meta>
        <meta itemProp="name" content="Kumpulan artikel motivasi diri, pengembangan diri, self love, tips dan trik, gaya hidup hidup untuk milenial Indonesia." />
        <meta itemProp="description" content="Kumpulan artikel motivasi diri, pengembangan diri, self love, tips dan trik, gaya hidup hidup untuk milenial Indonesia." name="description" />
