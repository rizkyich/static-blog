...
const TechSocialMedia = ({initData}) => {
   // console.log(initData)
   const requestListArticleParam = {
    path: 'blog-viewtype',
    params: 'type',
    data: 'techsocialmedia',
    method: 'post'
  }
  ...
  return (
    <>
      <Head>
        <title>Artikel Seputar Teknologi untuk Milenial</title>
        <meta property="og:title" content="Artikel Seputar Teknologi untuk Milenial"></meta>
        <meta itemProp="name" content="Dapatkan insight terbaru seputar teknologi dan media sosial yang sedang populer di seluruh dunia." />
        <meta itemProp="description" content="Dapatkan insight terbaru seputar teknologi dan media sosial yang sedang populer di seluruh dunia." name="description" />
...
TechSocialMedia.getInitialProps = async ({req, res, isServer}) => {
  let initData = {}
  try {
    if (isServer) {
      const requestListArticleParam = {
...
export default TechSocialMedia